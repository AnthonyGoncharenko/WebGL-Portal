class Skybox {
    constructor() {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, flatten(this.vPositions), gl.STATIC_DRAW); this.aPosition = gl.getAttribLocation(this.program, "aPosition");
        ...
        image1.src = "textures/concrete_modular_floor3.png";
        ...
        image2.src = "textures/concrete_modular_floor3.png";
        ...
        image3.src = "textures/concrete_modular_floor3.png";
        ...
        image4.src = "textures/concrete_modular_floor3.png";
        ...
        image5.src = "textures/concrete_modular_floor3.png";
        ...
        image6.src = "textures/concrete_modular_floor3.png";
    }
    build() {
        var vertices = [
            vec3(-1, -1, 1),
